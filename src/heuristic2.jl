using JuMP, CPLEX,ArgParse, Random
include("read_files.jl")
include("utils.jl")

global rng = MersenneTwister(1234)

file_names = ["dfn-bwin/dfn-bwin_1/","dfn-bwin/dfn-bwin_2/","dfn-bwin/dfn-bwin_3/","dfn-bwin/dfn-bwin_4/","dfn-bwin/dfn-bwin_5/","dfn-bwin/dfn-bwin_6/","dfn-bwin/dfn-bwin_7/","dfn-bwin/dfn-bwin_8/","dfn-bwin/dfn-bwin_9/","dfn-bwin/dfn-bwin_10/","di-yuan/di-yuan_1/","di-yuan/di-yuan_2/","di-yuan/di-yuan_3/","di-yuan/di-yuan_4/","di-yuan/di-yuan_5/","di-yuan/di-yuan_6/","di-yuan/di-yuan_7/","di-yuan/di-yuan_8/","di-yuan/di-yuan_9/","di-yuan/di-yuan_10/"]
...
for file_name in file_names
    ...
    function mp_heuristic()
        ...
        param_nodes = 2/3
        param_func = 1
        constraigned_nodes = randperm(rng,nb_nodes)
        constraigned_nodes = constraigned_nodes[1:Int64(round(param_nodes*nb_nodes))]
        constraigned_func = randperm(rng,nb_func)
        constraigned_func = constraigned_func[1:Int64(round(param_func*nb_func))]
        # Minimize opening and intallation cost
        @objective(  mp_h, Min,node_open_cost + sum(func_cost[i, f] * nb_functions[i, f] for i in constraigned_nodes, f in constraigned_func) )
